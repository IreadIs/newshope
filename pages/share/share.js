...
Page({
  ...
  onLoad: function (options) {
    ...
    app.getUserInfo(function (retuser) {
      ...
      if (options) {
        wx.request({
          dataType: "json",
          url: "https://qiyeplus.qiyeplus.com/mobile/ajax/service.php?module=share&action=list&pagestart=0&limit=20&uid=" + uid,
          type: "get",
          data: {
  ...
  setSearchStorage: function (e) {
    ...
    wx.request({
      dataType: "json",
      url: "https://qiyeplus.qiyeplus.com/mobile/ajax/service.php?action=search&module=share&pagestart=0&limit=20&comefrom=small",
      type: "get",
      data: {
        littleid: curuser.littleid,
        keyword: inputValue
